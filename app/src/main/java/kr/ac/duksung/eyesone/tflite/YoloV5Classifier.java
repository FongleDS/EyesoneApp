...
package kr.ac.duksung.eyesone.tflite;
...
import kr.ac.duksung.eyesone.SubActivity;
...
public class YoloV5Classifier implements Classifier {
    public static YoloV5Classifier create(
        ...
        Log.d("YoloV5Classifier", "isModelQuantized" + isQuantized);
        ...
        d.numClass = numClass;
        d.outData = ByteBuffer.allocateDirect(1 * d.output_box * (numClass + 5) * numBytesPerChannel);
    ...
    public float getObjThresh() {
        return SubActivity.MINIMUM_CONFIDENCE_TF_OD_API;
    }
