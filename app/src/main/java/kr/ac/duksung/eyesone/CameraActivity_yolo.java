...
public abstract class CameraActivity_yolo extends AppCompatActivity
...
//        CompoundButton.OnCheckedChangeListener,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> deviceAdapter =
                new ArrayAdapter<>(
                        CameraActivity_yolo.this , R.layout.deviceview_row, R.id.deviceview_row_text, deviceStrings);
        ...
        ArrayAdapter<String> modelAdapter =
                new ArrayAdapter<>(
                        CameraActivity_yolo.this , R.layout.listview_row, R.id.listview_row_text, modelStrings);
...
//      }
            String[] files = mgr.list(path);
            for (String file : files) {
                if (file.equals("yolov5s-fp16.tflite")) { // 원하는 모델 파일명
                    res.add(file);
                }
            }
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    CameraActivity_yolo.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
